...
#select 95 random stranger distances to plot
pwdist.rand <-unique(pwdist[round(runif(150,1,2640))])
pwdist.rand <- pwdist.rand[!is.na(pwdist.rand)]
pwdist.rand <- pwdist.rand[1:95]
